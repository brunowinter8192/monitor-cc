...
**Purpose:** Proves rag-cli failures return None with one note per state change, only a missing file reads as no last run, and running state comes from the handle.
