# P1 — pane_error_log probe run (2026-09-15T19:24:52.911815+00:00)

**Result: 47/47 checks passed**

| Check | Result |
|---|---|
| [worker_tokens] loop terminated via _ProbeStop, not an unhandled crash | PASS |
| [worker_tokens] survived past the crash iteration (>=2 ticks reached) | PASS |
| [worker_tokens] injected exception logged with this pane's identifier | PASS |
| [worker_tokens] full traceback recorded (Traceback... line present) | PASS |
| [worker_tokens] finally: cleanup ran (disable_mouse + restore_terminal called) | PASS |
