# P2 — model_params probe run (2026-09-13T14:34:43.861147+00:00)
...
| (a) confirms by content: src/proxy/strip_inject_delta.py's own _FIELD_STRIP_FN still has no context_management entry (left untouched — it was never live) | PASS |
