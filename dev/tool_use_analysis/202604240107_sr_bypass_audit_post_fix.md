# SR Bypass Audit — 2026-04-24 01:07
...
|---|---|---|---|---|
| task-tools-nag | full | 2432 | 0 | 0.0% |
| pyright-diagnostics | full | 175 | 0 | 0.0% |
| deferred-tools | full | 192 | 0 | 0.0% |
| user-interrupt | partial | 0 | 6 | 100.0% |
| system-notification | full | 0 | 235 | 100.0% |
| file-modified | full | 0 | 0 | n/a |
| claudemd-contents | full | 285 | 47 | 14.2% |
| date-changed | full | 0 | 103 | 100.0% |
| skills-available | full | 192 | 0 | 0.0% |
...
| template | mode | captured | bypassed | bypass_rate |
|---|---|---|---|---|
| task-tools-nag | full | 8491 | 288 | 3.3% |
| pyright-diagnostics | full | 1895 | 0 | 0.0% |
| deferred-tools | full | 673 | 0 | 0.0% |
| user-interrupt | partial | 141 | 148 | 51.2% |
| system-notification | full | 221 | 987 | 81.7% |
| file-modified | full | 0 | 109 | 100.0% |
| claudemd-contents | full | 766 | 646 | 45.8% |
| date-changed | full | 0 | 103 | 100.0% |
| skills-available | full | 673 | 0 | 0.0% |
| plan-mode | full | 0 | 0 | n/a |
