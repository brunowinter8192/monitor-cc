...
| check | result | detail |
|---|---|---|
| menubar log and settings resolve under the isolated home | PASS | MENUBAR_LOG=<home>/Library/Application Support/com.brunowinter.monitor-cc-menubar/menubar.log |
