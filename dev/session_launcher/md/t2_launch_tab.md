...
| log_isolation | PASS | launch log line landed in <home>/Library/Application Support/com.brunowinter.monitor-cc-menubar/menubar.log |
...
| start_command | PASS | 10 commands match exactly, e.g. cd /fake/monitor-cc-root && PATH="$HOME/.local/bin:$PATH" ./src/claude_proxy_start.sh --project /Users/brunowinter2000/Documents/ai/Meta/ClaudeCode/cli/gh-cli |
