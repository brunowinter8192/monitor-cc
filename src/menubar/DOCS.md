...
- **Session status detection** (Workers + Mains): Priority-1/2/3 fallback chain with threshold values — see `process-docs/menubar_session_status/menubar_session_status.md` for full IST chain.
