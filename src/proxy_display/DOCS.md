...
**Called by:** `src/proxy_display/pane.py`, `src/proxy_display/worker_proxy_pane.py`, `src/panes/warnings_pane.py`, `src/metadata/metadata_pane.py`; `_find_dual_log_paths` + `accumulate_dual_log` + `_infer_model_family` called by `pane.py` and `worker_proxy_pane.py`
**Calls out:** —
