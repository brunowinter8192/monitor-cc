...
**Called by:** `src/proxy_display/format.py`
**Calls out:** `render_messages` (`_aggregate_req_buckets`), `render_sections` (`render_fields_delta`, `render_beta`, `render_system_blocks`, `render_tools`)

---

### render_sections.py (320 LOC)
