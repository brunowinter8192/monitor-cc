...
**Calls out:** `session_finder`, `jsonl`; lazy: `panes`, `workers`, `proxy_display`, `metadata`, `input.click_handler` (copy_to_clipboard, read_mouse_event with sentinel-aware return).
