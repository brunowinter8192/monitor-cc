...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('--mode', type=str, choices=['all', 'main', 'subagent', 'rules', 'warnings', 'hooks', 'tokens', 'workers', 'proxy', 'metadata', 'worker-proxy', 'worker-metadata'], default='all', help='Monitor mode: all, main, subagent, rules, warnings, hooks, tokens, workers, proxy, metadata, worker-proxy, or worker-metadata')
