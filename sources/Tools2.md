...
Send a request with your tools array and the user message.
Claude responds with stop_reason: "tool_use" and one or more tool_use blocks.
Execute each tool. Format the outputs as tool_result blocks.
...
Repeat from step 2 while stop_reason is "tool_use".
