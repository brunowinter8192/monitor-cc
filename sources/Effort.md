...
The effort parameter is supported by Claude Mythos Preview, Claude Opus 4.6, Claude Sonnet 4.6, and Claude Opus 4.5.
...
The effort parameter works alongside extended thinking. Its behavior depends on the model:
    ...
    Claude Mythos Preview uses adaptive thinking by default (no thinking configuration required). thinking: {type: "disabled"} is rejected. Effort controls thinking depth the same way as on Opus 4.6.
