...
Configures tmux session appearance and behavior after session creation. Disables the status bar for a cleaner interface and sets pane border colors to subtle grey tones instead of the default green.
