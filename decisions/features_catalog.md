...
- **Source file(s):** `sources/Compaction1.md`, `sources/Compaction2.md`, `sources/Compaction3.md`, `sources/Compaction4.md`
...
- **Source file(s):** `sources/ContextEditing1.md` – `sources/ContextEditing5.md`
...
- **Source file(s):** `sources/PromptCaching1.md`
...
- **Source file(s):** `sources/ContextWindow.md`
...
- **Source file(s):** `sources/ToolSearch1.md`, `sources/ToolSearch2.md`, `sources/ToolSearch3.md`
...
- **Source file(s):** `sources/Skills1.md` – `sources/Skills6.md`
...
- **Source file(s):** `sources/Compaction3.md`
...
- **Source file(s):** `sources/Effort.md`
...
- **Source file(s):** `sources/Stop-Verhalten1.md` – `sources/Stop-Verhalten5.md`
...
- **Source file(s):** `sources/FineGrained1.md`
...
- **Source file(s):** `sources/Structured_outputs.md` – `sources/Structured_outputs4.md`
...
- **Source file(s):** `sources/Compaction1.md`, `sources/Compaction2.md`
...
- **Source file(s):** `sources/ContextEditing3.md`
...
- **Source file(s):** `sources/Search_results1.md`, `sources/Search_results2.md`
...
- **Source file(s):** `sources/Streaming_Refusals.md`
...
- **Source file(s):** `sources/ProgToolCalling1.md`, `sources/ProgToolCalling2.md`, `sources/ProgToolCalling3.md`
...
- **Source file(s):** `sources/Citations1.md`, `sources/Citations2.md`, `sources/Citations3.md`
...
- **Source file(s):** `sources/ToolSearch3.md`, `sources/Tools6.md`, `sources/Streaming_Messages5.md`
...
- **Source file(s):** `sources/Compaction1.md`, `sources/ToolSearch2.md`, `sources/Search_results1.md`, `sources/Tools3.md`, `sources/Streaming_Messages5.md`
